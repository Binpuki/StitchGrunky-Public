...
import states.stages.Default as BackgroundStage;

class NoteOffsetState extends MusicBeatState
{
	var stageDirectory:String = 'default';
	...
	override public function create()
	{
		...
		changeModeText.setFormat(Paths.font("neon.ttf"), 32, FlxColor.WHITE, CENTER);
	...
	function createTexts()
	{
		for (i in 0...4)
		{
			...
			text.setFormat(Paths.font("neon.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
