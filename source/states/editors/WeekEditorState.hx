...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		missingFileText.setFormat(Paths.font("neon.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("neon.ttf");
	...
	function reloadBG() {
		...
		if(assetName != null && assetName.length > 0) {
			...
			Assets.exists(Paths.getPath('images/menubackgrounds/menu_' + assetName + '.webp', IMAGE), IMAGE)) {
	...
	function reloadWeekThing() {
		...
		if(assetName != null && assetName.length > 0) {
			...
			Assets.exists(Paths.getPath('images/storymenu/' + assetName + '.webp', IMAGE), IMAGE)) {
		...
		if(isMissing) {
			...
			missingFileText.text = 'MISSING FILE: images/storymenu/' + assetName + '.webp';
		}
...
class WeekEditorFreeplayState extends MusicBeatState
{
	...
	override function create() {
		bg = new FlxSprite().loadGraphic(Paths.image('yakuza'));
