...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		bg = new FlxSprite();
		bg.frames = Paths.getSparrowAtlas("MENUS/FREEPLAY/BGfreeplay");
		...
		scoreText.setFormat(Paths.font("neon.ttf"), 32, FlxColor.WHITE, RIGHT);
		...
		bottomText.setFormat(Paths.font("neon.ttf"), size, FlxColor.WHITE, CENTER);
